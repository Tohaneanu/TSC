...
# eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -sva top
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -sva -G/top/test/NUMBER_OF_TRANSACTIONS=$2 -G/top/test/RND_CASE=$3 -G/top/test/SEED=$4 -G/top/test/TEST_NAME=$5 top
